...
public interface ArticleBiz {
	...
	List<Article> getArticles(@Param("userId")int userId,@Param("cateId")Integer cateId,@Param("title")String title,@Param("page")Integer page,@Param("pageSize")int pageSize);
